...
urlpatterns = patterns('',
    ...
    url(r'^procedure/(?P<proc_id>[0-9]+)/edit$',
    'school_qms.views.procedures_page', name='procedure_edit'),
    url(r'^procedure/(?P<proc_id>[0-9]+)/$',
    'school_qms.views.procedure_page', name='procedure'),
